...
//we will be using the widely used Bouncy Castle library for this assignment
//Bouncy Castle is a collection of APIs used in cryptography. It is also the name of the company that developed it.
